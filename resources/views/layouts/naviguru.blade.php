<nav x-data="{ open: false }"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('reward')" :active="request()->routeIs('reward')" class="text-white hover:text-gray-200">
                {{ __('Reward') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('users.index')" :active="request()->routeIs('users.index')" class="text-white hover:text-gray-200">
                {{ __('Users') }}
            </x-responsive-nav-link>
        </div>

        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('shift-code.index')" :active="request()->routeIs('shift-code.index')" class="text-white hover:text-gray-200">
                {{ __('Shift') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('shift-schedules.index')" :active="request()->routeIs('shift-schedules.index')" class="text-white hover:text-gray-200">
                {{ __('jadwal Shift') }}
            </x-responsive-nav-link>
        </div>
